...
* `git clone git@github.com:rumblex/angularattack2016-teamup.git`

* `cd angularattack2016-teamup`
...
If you receive an error message `"You do not have permission to publish to teamup.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add mahbubani.amit@gmail.com,gtm93singh@gmail.com`
